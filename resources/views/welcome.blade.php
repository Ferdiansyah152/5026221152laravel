...
<body>
    ...
    <footer class="footer text-center">
        <div class="container">
            ...
            <a href="{{url('tugas1')}}"><i class="footer text-center"></i> pertemuan 1</a>
            <a href="{{url('Hello')}}"><i class="footer text-center"></i> pertemuan 2.1</a>
            <a href="{{url('Style')}}"><i class="footer text-center"></i> pertemuan 2.2</a>
            <a href="{{url('Style2')}}"><i class="footer text-center"></i> pertemuan 2.3</a>
            <a href="{{url('responsive1')}}"><i class="footer text-center"></i> pertemuan 3</a>
            <a href="{{url('Latsol')}}"><i class="footer text-center"></i> pertemuan 5</a>
            <a href="{{url('form')}}"><i class="footer text-center"></i> pertemuan 7.template</a>
            <a href="{{url('formulir')}}"><i class="footer text-center"></i> pertemuan 7</a>
        </div>
    </footer>
